...
The column names are variables (range of income) and each observation does not have its own row. The observations are grouped in a single row by religion. 
...
Some column names are variables (day1, day2, day3, etc.). Observations are grouped by genotype, they do not have their own rows. 

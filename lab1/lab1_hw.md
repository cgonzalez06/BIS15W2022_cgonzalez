...
R is a scripting language. RStudio is the graphical user interface used to interact with the R language. Github is a site used to store and manage files/data. GitHub is useful to programmers because it allows them to collaborate on projects and easily manage or track different versions of files as changes are made. 
...
The results to the second expression surprised me. 

...
A vector is sequence of data of the same type, either numeric, integer, logical, character, or complex. 

2. What is a data matrix in R?  
A data matrix is a collection of vectors arranged into rows and columns. 

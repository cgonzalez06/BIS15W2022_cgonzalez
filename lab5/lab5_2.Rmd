...
```
Asgardians are Sif, Thor, and Thor Girl
...
```
Male humans over 200 inches in height are Bane, Doctor Doom, Kingpin, Lizard, and Scorpion. 
...
superhero_info %>% 
  filter(weight>450)
```
We don't have 16 rows in row 10 because some superheroes meet both conditions (height>300 or weight>450), so they show up in the answers for both question 11 and question 12, but only once in the the answer for question 10. 

...
```
## # A tibble: 734 × 4
##    name        weight height height_weight_ratio
##    <chr>        <dbl>  <dbl>               <dbl>
##  1 Giganta        630   62.5               10.1 
##  2 Utgard-Loki     58   15.2                3.82
##  3 Darkseid       817  267                  3.06
##  4 Juggernaut     855  287                  2.98
##  5 Red Hulk       630  213                  2.96
##  6 Sasquatch      900  305                  2.95
##  7 Hulk           630  244                  2.58
##  8 Bloodaxe       495  218                  2.27
##  9 Thanos         443  201                  2.20
## 10 A-Bomb         441  203                  2.17
## # … with 724 more rows
```

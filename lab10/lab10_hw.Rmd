...
deserts %>% 
  ...
  arrange(desc(n))
```
26 genera and 40 species represented. Clarki, scutalatus, tereticaudus, tigris, uniparens, viridis were all only sampled 1 time. Merriami was sampled the most.
...
```{r}
deserts %>% 
  filter(species=="flavus" | species=="albigula") %>% 
